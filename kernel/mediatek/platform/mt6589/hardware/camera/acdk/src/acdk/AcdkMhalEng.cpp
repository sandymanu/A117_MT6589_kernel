...
MINT32 AcdkMhalEng::acdkMhal3ASetParam(MINT32 devID, MUINT8 IsFactory)
{
    ...
    //BEGIN<SNTZT-207,SNTZT-4><there is banding in ftm test><20130710>panchenjun
    if(IsFactory){
        cam3aParam.u4AntiBandingMode = 1;
    }
    //END<SNTZT-207,SNTZT-4><there is banding in ftm test><20130710>panchenjun
