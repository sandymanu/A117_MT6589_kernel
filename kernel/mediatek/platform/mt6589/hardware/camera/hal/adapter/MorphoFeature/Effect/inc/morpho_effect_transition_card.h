/**
 * @file    morpho_effect_transition_card.h
 * @brief   Morpho Transition Effect "CARD" module.
 *
 * effect_name     ...  "TR_CARD"
 * needs_image_num ...  2
 *
 ...
 */
#ifndef MORPHO_EFFECT_TRANSTION_CARD_H
#define MORPHO_EFFECT_TRANSTION_CARD_H
...
} morpho_EffectTransitionCardParam;

#ifdef __cplusplus
} /* extern "C" { */
#endif

#endif /* #ifndef MORPHO_EFFECT_TRANSTION_CARD_H */
