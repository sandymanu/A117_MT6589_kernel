...
createJpegImgWithThumbnail(NSCamHW::ImgBufInfo const &rYuvImgBufInfo, NSCamHW::ImgBufInfo const &rPostViewBufInfo, MUINT32 const Mode)
{
    ...
    #ifdef JPG_FLIP  //add jpg flip
    ret = ret && createJpegImg(rYuvImgBufInfo, yuvJpegParam, mShotParam.mi4Rotation, getOpenId()==1? mShotParam.mi4Flip:0 , rJpegImgBufInfo, u4JpegSize);
    #else
    ...
    if (0 != mJpegParam.mi4JpegThumbWidth && 0 != mJpegParam.mi4JpegThumbHeight)
    {
        ...
        #ifdef JPG_FLIP  //add jpg flip
        ret = ret && createJpegImg(rPostViewBufInfo, rParam, mShotParam.mi4Rotation, getOpenId()==1? mShotParam.mi4Flip:0, rThumbImgBufInfo, u4ThumbSize);
        #else
