 ...
 * @date     2008-07-01
 * 
 * Copyright (C) 2006-2008 Morpho, Inc.
 */
 ...
 * @return            画像に必要なメモリサイズ
 */
#define morpho_getImageSize mor_eff_IF_getImageSize
 ...
 * @return            Y画像データサイズ
 */
#define morpho_getImageSizeY mor_eff_IF_getImageSizeY
 ...
 * @return            U画像データサイズ
 */
#define morpho_getImageSizeU mor_eff_IF_getImageSizeU
 ...
 * @return            V画像データサイズ
 */
#define morpho_getImageSizeV mor_eff_IF_getImageSizeV
 ...
 * @return            UV画像データサイズ
 */
#define morpho_getImageSizeUV mor_eff_IF_getImageSizeUV
