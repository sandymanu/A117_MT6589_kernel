...
onRaw_capture(CapBufQueNode & rNode)
{
    ...
    NSCamShot::ShotParam rShotParam(eImgFmt_YUY2,         //yuv format
			 ...
			 (getOpenId()==1? mShotParam.mi4Flip:0), //picture flip
#else
                         0,                               //picture flip
#endif   
...
onYuv_alloc(ImgBufInfo   & rJpgImgBufInfo, ImgBufInfo & rYuvImgBufInfo, ImgBufInfo & rThumbImgBufInfo)
{
    ...
    if ( mJpegMem.size == 0)
    {
        ...
        mJpegMem.size = u4Width * u4Height ;    //LINE <SNTZT-56> <DATE20130718> <open zsd,ISO 1600,cannot show capture photo> wupingzhou
