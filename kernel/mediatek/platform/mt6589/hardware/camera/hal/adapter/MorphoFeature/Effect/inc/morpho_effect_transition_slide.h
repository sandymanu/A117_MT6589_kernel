/**
 * @file    morpho_effect_transition_slide.h
 * @brief   Morpho Transition Effect "SLIDE" module.
 *
 * effect_name     ...  "TR_SLIDE"
 * needs_image_num ...  2
 *
 * Copyright (C) 2009 Morpho, Inc.
 */
#ifndef MORPHO_EFFECT_TRANSTION_SLIDE_H
#define MORPHO_EFFECT_TRANSTION_SLIDE_H
...
} morpho_EffectTransitionSlideParam;

#ifdef __cplusplus
} /* extern "C" { */
#endif

#endif /* #ifndef MORPHO_EFFECT_TRANSTION_SLIDE_H */
