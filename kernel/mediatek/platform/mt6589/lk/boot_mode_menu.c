...
//BEGIN <ftm> <DATE2013118> <ftm ker V+ + V-> zhangxiaofei
...
//END <ftm> <DATE2013118> <ftm ker V+ + V-> zhangxiaofei
...
//BEGIN <ftm> <DATE2013118> <ftm ker V+ + V-> zhangxiaofei
    ...
    {
		if(mtk_detect_key(MT65XX_BOOT_MENU_KEY)&&mtk_detect_key(MT65XX_MENU_OK_KEY))
		{
                           mtk_wdt_disable();
