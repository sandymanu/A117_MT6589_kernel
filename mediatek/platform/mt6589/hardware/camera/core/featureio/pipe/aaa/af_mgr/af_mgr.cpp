...
{
	m_FDArea.i4Count=0;//LINE <SJSOIB-165> <DATE20130608> <sometimes can not auto focus> wupingzhou
	m_pIAfAlgo->setFDWin(m_FDArea);//LINE <SJSOIB-165> <DATE20130608> <sometimes can not auto focus> wupingzhou
