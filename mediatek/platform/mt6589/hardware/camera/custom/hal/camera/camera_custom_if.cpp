...
* custom exif
*******************************************************************************/
#define EN_CUSTOM_EXIF_INFO//LINE <SJSOIB-23 > <DATE20130509> <modify camera EXIF: "maker","Model"> wupingzhou
...
#define CUSTOM_EXIF_STRING_MODEL "DARKNIGHT"//"custom model"
...
#define CUSTOM_EXIF_STRING_MODEL "S9203"//LINE <SJSOIB-23 > <DATE20130509> <modify camera EXIF: "maker","Model"> wupingzhou
#define CUSTOM_EXIF_STRING_SOFTWARE "S9203"//LINE <SJSOIB-23 > <DATE20130509> <modify camera EXIF: "maker","Model"> wupingzhou
static customExifInfo_t exifTag = {CUSTOM_EXIF_STRING_MAKE,CUSTOM_EXIF_STRING_MODEL,CUSTOM_EXIF_STRING_SOFTWARE};
    if (0 != ppCustomExifTag) {
        *ppCustomExifTag = (void*)&exifTag;
    }
