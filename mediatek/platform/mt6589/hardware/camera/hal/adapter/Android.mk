...
LOCAL_C_INCLUDES += $(TOP)/$(MTK_PATH_PLATFORM)/hardware/camera/common/morphoFeature/beauty
...
LOCAL_WHOLE_STATIC_LIBRARIES += libcam.camadapter.morphofeature
...
LOCAL_SHARED_LIBRARIES += libaccess_beautifier
LOCAL_SHARED_LIBRARIES += libaccess_skin_beauty
LOCAL_SHARED_LIBRARIES += libaccess_beautifier_c
#-----------------------------------------------------------
