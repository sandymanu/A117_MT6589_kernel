...
typedef struct {
    ...
    morpho_RectInt face_rects[MORPHO_EFFECT_FILTERING_MONA_MAX_FACE_RECTS];  /* 顔矩形 */
    int angles[MORPHO_EFFECT_FILTERING_MONA_MAX_FACE_RECTS]; /* 顔矩形の向き MORPHO_EFFECT_ENGINE_INCLINATION_～で指定*/
    int rect_num;               /* 顔矩形数 */
